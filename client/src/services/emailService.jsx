...
<head>
  <meta charset="UTF-8" />
  <title>Welcome to AskTask</title>
</head>
...
">
  ...
  ">
    ...
    <p style="
      ...
      color:#5f6980;
    ">
      Your AskTask account has been created
      successfully.
    </p>
...
`,
    ...
    textContent:
      `Welcome to AskTask, ${user.name}!

Your AskTask account has been created successfully.
...
async function sendLoginNotification(user) {
  return sendEmail({
    ...
    subject:
      "New login to your AskTask account",
...
">
  ...
  ">
    ...
    <p style="
      ...
      color:#5f6980;
    ">
      Your AskTask account was just signed in.
    </p>
    ...
    ">
      ...
      use the password reset option in AskTask
      immediately.
    </p>
...
If this was you, no action is required.
If you do not recognize this login,
reset your AskTask password immediately.`,
  });
}
